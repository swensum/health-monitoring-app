...
public final class PrefsHelper {
    ...
    public final static class Builder {
        ...
        public Builder setMode(final int mode) {
            if (mode == Context.MODE_PRIVATE || mode == Context.MODE_MULTI_PROCESS) {
                mMode = mode;
            } else {
                throw new RuntimeException("The mode in the SharedPreference can only be set to Context.MODE_PRIVATE or Context.MODE_MULTI_PROCESS");
            }
